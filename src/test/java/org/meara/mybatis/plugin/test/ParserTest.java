...
public class ParserTest {
    ...
    public void selectTest() {
        ...
        Assertions.assertEquals("SELECT bid, book_name FROM book WHERE book.tid = '2'",
                newSql);
    }
    ...
    public void insertSelectTest() {
        ...
        String newSql = defaultSqlParser.setTenantParameter(sql);
        Assertions.assertEquals("INSERT INTO book (bid, book_name, tid) SELECT ?, username, '2' FROM `user` WHERE `user`.tid = '2' LIMIT 1",
                newSql);
    }
    ...
    public void leftJoinTest() {
        ...
        String newSql = defaultSqlParser.setTenantParameter(sql);
        Assertions.assertEquals("SELECT a1.id, a2.name AS a2Name, a3.name AS a3Name FROM t1 a1 LEFT JOIN t2 a2 ON a2.tid = '2' AND a1.id = a2.id LEFT JOIN t2 a3 ON a3.tid = '2' AND a1.gid = a3.id WHERE a1.tid = '2'",
                newSql);
    }
    ...
    public void selectSelectTest() {
        ...
        String newSql = defaultSqlParser.setTenantParameter(sql);
        Assertions.assertEquals("SELECT a FROM table1 WHERE table1.tid = '2' AND column1 = (SELECT column1 FROM table2 WHERE table2.tid = '2' AND a = 1)",
                newSql);
    }
}
